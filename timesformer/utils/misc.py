...
# from matplotlib import pyplot as plt    # AG something is wrong with this import
...
def gpu_mem_usage():
    ...
    if torch.cuda.is_available():
        ...
        mem_usage_bytes = 0
    print(f"GPU Memory usage - ",(mem_usage_bytes / 1024 ** 3),"GB")#HEZI
...
def cpu_mem_usage():
    ...
    print(f"CPU Memory usage - ",usage,"GB")#HEZI
    process = psutil.Process(os.getpid())#HEZI
    mem = process.memory_info()[0] / 1024 ** 3#HEZI
    print(f"CPU Process Memory usage - ",mem,"GB")#HEZI
