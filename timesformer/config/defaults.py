...
# prediction results.
# _C.TRAIN.NUM_ENSEMBLE_VIEWS = 1       # AG for explainability
##
...
_C.MODEL.MULTI_PATHWAY_ARCH = ["slowfast", "vit"] # AG for Explainability
...
# AG: Model classifcaion type, "classes", "ordinal_regress" , "regression" (TODO support regresson)
_C.MODEL.CLASSIFY_TYPE = "classes"
...
_C.EXP_NAME = "TimeSformer"    # AG for explainability
