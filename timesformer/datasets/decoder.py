...
import cv2    # AG added for explainability
...
, duration=None, frames_length=None):
    ...
    if frames_length == 0:
        frames_length = cv2_frames_length(container.name)   # AG added for explainability
    ...
    if duration is None:
        ...
        if frames_length > 0:
           timebase = duration / frames_length
            ...
            timebase = tb      # AG added for explainability            
